...
class Slack extends webhook_1.IncomingWebhook {
     ...
     * Generate payload
     */
    generatePayload(status, msg, username, icon_emoji, mention) {
     ...
     */
    notify(status, msg, username, icon_emoji, mention) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const payload = this.generatePayload(status, msg, username, icon_emoji, mention);
